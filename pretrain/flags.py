...
def roberta_model_configuration():  ## unmatched function name "roberta_model_configuration_flags
    flags.DEFINE_float(
...
def tokenizer_flags():
    flags.DEFINE_string(
        name="tokenizer_path",
        default="/home/junlin/Documents/sft/scenarios/chem/tokenizers/SMILES_tokenized_PubChem_shard00_160k",
